...
public class KhachHang {
    ...
    public String toString() {
        return "KhachHang{" + "MaKH=" + MaKH + ", TenKH=" + TenKH + ", SoDT=" + SoDT + ", DiaChi=" + DiaChi + ", CongViec=" + CongViec + ", SoCMND=" + SoCMND + ", GioiTinh=" + GioiTinh + ", LoaiTK=" + LoaiTK + ", GhiChu=" + GhiChu + ", TrangThai=" + TrangThai + '}';
    }
